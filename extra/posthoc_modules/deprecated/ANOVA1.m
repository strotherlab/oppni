function out = ANOVA1( datamat, design )
%
% . 1-way ANOVA --> 1 experimental manipulation, multiple levels
%

% signif=0.05;

if( size(design,2)  >1 )
    error('can only have 1 random factor');
end
...
% group effect
out.fstat_G    = MSB./MSW;
out.fstat_G_p  = 1-fcdf(out.Fstat,(kk-1),sum(nn) - kk);
