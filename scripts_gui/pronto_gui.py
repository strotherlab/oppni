...
# Allow the class to run stand-alone.
    ...
    def set_tooltip_messages(self):
        ...
        CreateToolTip(self.lstep4,"STEP 4: This is last step of OPPNI preprocessing! \n You can set some advanced settings in the above menu 4:Run")
