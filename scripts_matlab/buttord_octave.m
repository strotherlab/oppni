function [order,wn] = buttord_octave(wp,ws,rp,rs,opt)
% Modified version of buttord from the MATLAB stats toolbox, so that it
...
% Octave Change for secondary function
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[msg,msgobj]=freqchk_octave(wp,ws,opt);
