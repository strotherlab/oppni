function output = dPLS( datamat, split_info, Resampling_Index )
%
% =========================================================================
...
output.attributes.model_name  = 'dPLS';
...
%% GROUP LEVEL ANALYSIS
    ...
    error('sorry! Group level dPLS analysis not yet implemented! Check back later.');
end
