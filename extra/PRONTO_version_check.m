function out = PRONTO_version_check( InputFile1, InputFile2, out_name, distatis_flag )
%
%
% Syntax: 
%             out = PRONTO_version_check( InputFile1, InputFile2, out_name, distatis_flag );
%
% Input:       
%             InputFile1, InputFile2: strings, giving path+name of the input text-files
%                                     used to generate PRONTO outputs being compared
%             out_name              : name of output textfile summarizing comparison 
%                                     between PRONTO outputs
...
fprintf(fin,'Comparing PRONTO version outputs from:\n    Output-1: %s\n    Output-2: %s\n\n',InputFile1,InputFile2);
