function [InputStruct] = Read_Input_struct_vbm(inputfile)
...
while ischar(tline) 
    ...
    [Input_nifti_file_path,Input_nifti_file_prefix,Output_nifti_file_path,Output_nifti_file_prefix] = Parse_Input_struct_vbm(tline);
